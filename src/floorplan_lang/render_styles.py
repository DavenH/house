...
def wall_plan_style(*, exterior_opening_mask_stroke: float, interior_opening_mask_stroke: float, interior_open_stroke: float) -> list[str]:
    return [
        ...
        ".overlay-line{fill:none;stroke-linecap:round;stroke-linejoin:round;opacity:.92;pointer-events:none}",
        ".overlay-node{stroke:#fff;stroke-width:1;opacity:.95;pointer-events:none}",
